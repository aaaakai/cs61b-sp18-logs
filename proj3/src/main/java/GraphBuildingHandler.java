...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    private LinkedList<Long> wayNode = new LinkedList<>();
...
//            System.out.println("Node lat: " + attributes.getValue("lat"));
            ...
            GraphDB.GraphNode newNode =
                    new GraphDB.GraphNode(Long.parseLong(attributes.getValue("id")),
...
//            System.out.println("Beginning a way...");
            ...
            wayNode.add(Long.parseLong(attributes.getValue("ref")));
            ...
            if (k.equals("maxspeed")) {
                ...
                if (ALLOWED_HIGHWAY_TYPES.contains(v)) {
                    Long preNode = wayNode.remove();
                    Long currentNode;
                    while (!wayNode.isEmpty()) {
                        currentNode = wayNode.remove();
                        g.addEdge(preNode, currentNode);
                        preNode = currentNode;
                    }
                }
